...
const Home = () => {
  const modes = [
    {
      title: "Blaze's Story",
      description: "Follow the journey of a CME named Blaze from the Sun to Earth through an interactive educational narrative with choices.",
      icon: BookOpen,
      path: "/story",
    ...
    },
    {
      ...
      description: "See real-time effects of space weather on Earth's technology, communications, satellites, and aurora creation.",
      icon: Telescope,
      path: "/impacts",
    ...
    },
    {
      ...
      description: "Explore interactive 3D visualizations of space weather events, solar flares, and CME travel from Sun to Earth.",
      icon: LineChart,
      path: "/simulation",
